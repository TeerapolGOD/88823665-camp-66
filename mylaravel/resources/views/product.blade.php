...
<table class="table">
            ...
            <tr>
                ...
                <td>
                    @if($category->products->count() > 0)
                        {{ $category->products->first()->user->name }}  <!-- Assuming you have a user relationship -->
                    @else
                        N/A
                    @endif
                </td>
  ...
  @section('scripts')
  <script>
    document.getElementById('btn-add-product-list').addEventListener('click', function() {
        const newProductDiv = document.createElement('div');
        newProductDiv.classList.add('col-6');
        ...
        newProductDiv.querySelector('.btn-del-product-list').addEventListener('click', function() {
